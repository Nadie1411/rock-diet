...
export default function CustomerService() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (query.trim().length < 5) {
      setError('Please describe your question (at least 5 characters).');
      return;
    }
      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary text-sm mt-1">
            Leave your number and question — our team will call you back.
          </p>
        </div>
            ...
            <>
              ...
              {!isAuthenticated && (
                <div className="mb-6 flex items-start gap-2 bg-primary/10 text-primary text-xs font-semibold px-4 py-3 rounded-lg border border-primary/20">
                  ...
                  <span>
                    No account needed — just leave your phone number and
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Query */}
                <div>
                  <label htmlFor="query" className="block text-xs font-semibold text-text mb-1.5">
                    How Can We Help?
                  </label>
                  <div className="relative">
